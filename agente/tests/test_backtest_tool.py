...
def test_summarize_backtest_excludes_aguardar_from_hit_rate() -> None:
    rows = [
        {"recommendation": "COMPRAR", "strategy_return": 0.05, "outcome": "acerto"},
        {"recommendation": "VENDER", "strategy_return": -0.02, "outcome": "erro"},
        {"recommendation": "AGUARDAR", "strategy_return": 0.0, "outcome": "neutro"},
    ]
...
def test_summarize_backtest_by_ticker_groups_metrics() -> None:
    rows = [
        {"ticker": "ITUB4", "recommendation": "COMPRAR", "strategy_return": 0.05, "outcome": "acerto"},
        {"ticker": "ITUB4", "recommendation": "AGUARDAR", "strategy_return": 0.0, "outcome": "neutro"},
        {"ticker": "VALE3", "recommendation": "VENDER", "strategy_return": 0.02, "outcome": "acerto"},
    ]
